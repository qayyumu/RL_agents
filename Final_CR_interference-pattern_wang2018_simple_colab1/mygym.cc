...
// this is getting the string out however it should return the dictionary
std::string
MyGymEnv::GetExtraInfo()
{
  NS_LOG_FUNCTION (this);
  std::string myInfo = "info. 'items': 0 'prob': 0.3333333333333333";
  NS_LOG_UNCOND("MyGetExtraInfo: " << myInfo);
  return myInfo;
}


//execute channel will get the channel selected (as action and pass it to reward thing)
bool
